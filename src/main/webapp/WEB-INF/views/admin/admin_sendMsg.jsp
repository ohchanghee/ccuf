    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
        ...
        <div class="row align-items-center position-relative mb-5">
            ...
            <div class="site-logo">
              ...
              <a href="/admin_users"><font style="position: absolute;top: 79%;left: 12%; font-size:70%; color:#fff;"> 회원 </font></a>
              <a href="/admin_recipe"><font style="position: absolute;top: 79%;left: 25%; font-size:70%; color:#fff;"> 레시피 </font></a>
              <a href="/admin_foodvideo"><font style="position: absolute;top: 79%;left: 38%; font-size:70%; color:#fff;"> 요리영상 </font></a>
              <a href="/recipegram_index"><font style="position: absolute;top: 79%;left: 52%; font-size:70%; color:#fff;"> 레시피그램 </font></a>
              <a href="/admin_chat"><font style="position: absolute;top: 79%;left: 67.5%; font-size:70%; color:#fff;"> 채팅방 </font></a>
              <a href="/admin_receiveMsg"><font style="position: absolute;top: 79%;left: 81.5%; font-size:70%; color:#fff;"> 메시지 </font></a>

            ...
            <div class="sign_up_body" style="padding: 40px 50px;">
              <form method = "post" id="signup_form" name="signup_form" action="/signup"> 
                  <div class="form_sign_up_group">
                     ...
                     <label for="user_pw">Password</label> &emsp; <span class="font-size-12 text-right" id="pwd_qual">영어 + 숫자 8 ~  15자 </span>
                     ...
                     <label for="user_pw_check">Password 확인</label> <br> <p id="pwchk_chk_text" style="display:none; color:#FFA19D;" >패스워드와 일치하지 않습니다.</p> <br> 

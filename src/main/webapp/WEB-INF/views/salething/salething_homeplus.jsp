        ...
        <div class="row">
          <div class="col-md-4 col-lg-3 mb-1 text-center">
            <div class="block-heading-1" style="font-color:white">
              ...
              <a href="salething_homeplus" id="homeplus"><h4 class="clickmart">홈플러스</h4></a>
        ...
        %>
          <div class="col-lg-3 col-md-4 mb-4 mb-lg-0 " data-aos="fade-up" >
            <div class="block-team-member-1 text-center rounded ">
            	...
            	<img src=<%=hp_img.get(i) %>  onclick="page_homeplus()" alt="Image" class="img-fluid">
               
              <h3 class="font-size-18 text-center mb-4 mt-4"><%=hp_title.get(i) %></h3>
              <span class="d-block font-gray-5 letter-spacing-1 text-uppercase font-size-13 mb-2">판매가: <%=hp_cost.get(i) %></span>
              <p class="px-3 font-size-16 mb-3">할인가격 : <%=hp_buy.get(i) %>원</p>
